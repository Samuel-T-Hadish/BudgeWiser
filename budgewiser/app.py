...
from budgewiser.config.main import CONFIG_SIDEBAR, STORE_ID, DATA_STORE
from budgewiser.project import Project
...
def init_app(
    ...
    material_data = pd.read_csv("budgewiser\\materials_factor.csv", encoding="ISO-8859-1").to_dict()
